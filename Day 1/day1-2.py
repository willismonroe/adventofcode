...
for instruction in data.split(', '):
    ...
    print("{}: We moved {}, {} blocks and are now at: {} a distance of {} blocks from {}".format(instruction, directions[facing], distance, cur_loc, distance_from_origin, start))
